...
{
    internal class ReceptMapiranja : ClassMap<Recept>
    {
        public ReceptMapiranja()
        {
            Table("RECEPT");

            Id(x => x.SerijskiBroj).Column("SERIJSKI_BROJ").GeneratedBy.TriggerIdentity();
            ...
            References(x => x.OblikPakovanja).Column("OBLIK_PAKOVANJA").Not.Nullable();
        }
    }
}
